...
import (
	...
	"github.com/rspier/caddy/v2/caddytest"
	"golang.org/x/net/http2"
	"golang.org/x/net/http2/h2c"
)

// (see https://github.com/rspier/caddy/issues/3556 for use case)
...
// (see https://github.com/rspier/caddy/issues/3606 for use case)
